<template>
    ...
    const feedbacks = ref([
      { author: 'John Doe', message: 'This product has completely transformed our business!' },
      { author: 'Jane Smith', message: 'Excellent customer service and very reliable product.' },
      { author: 'Michael Johnson', message: 'The features offered are unmatched by any other solution.' },
      { author: 'Emily Davis', message: 'Great value for the price, will definitely recommend!' },
      { author: 'Chris Lee', message: 'A must-have tool for anyone in the industry.' },
      { author: 'Sarah Brown', message: 'Top-notch quality and fantastic support.' },
      { author: 'Sarah Brown', message: 'Top-notch quality and fantastic support.' },
      { author: 'Sarah Brown', message: 'Top-notch quality and fantastic support.' },
      { author: 'Sarah Brown', message: 'Top-notch quality and fantastic support.' },
    ]);
